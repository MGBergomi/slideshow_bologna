import { WebGLRenderer, Scene, PerspectiveCamera, AmbientLight, DirectionalLight, Raycaster, Vector2, Vector3, Color } from 'three';
  ...
  methods: _extends({
    cameraPosition: function cameraPosition(state, position, lookAt) {
      ...
      if (position) {
        ...
        state.tbControls.target = lookAt ? new three.Vector3(lookAt.x, lookAt.y, lookAt.z) : state.forceGraph.position;
