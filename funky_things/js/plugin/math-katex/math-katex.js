...
window.RevealMath = window.RevealMath || (function() {
	...
	options.katexScript     = options.katexScript     || './funky_things/js/plugin/math-katex/lib/katex-0.10.2/katex.min.js';
	options.katexStylesheet = options.katexStylesheet || './funky_things/js/plugin/math-katex/lib/katex-0.10.2/katex.min.css';
